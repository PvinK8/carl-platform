...
export async function POST(req: NextRequest) {
  try {
    ...
    const promptParts = [
      'You are a Singapore recruitment consultant. Write a recruiter pitch for a hiring manager.',
      '',
      ...
      '}',
      '',
      'Open with a strong hook, highlight how past experience combines with new course skills, mention the SCTP programme, state salary, end with a call to action.',
    ];
